...
# # I (Shinichi) is too lazy to fill in roxgen stuff - Fonti could you do this???
...
#   ((10/(temp_2 - temp_1))^2) * (((r1.1_sd^2)/(r1.1_N * (r1.1^2))) + ((r1.2_sd^2)/(r1.2_N * (r1.2^2))) + (1/(2 * (r1.1_N - 1))) + (1/(2 * (r1.2_N - 1))))
