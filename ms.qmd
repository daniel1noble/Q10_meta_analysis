...
#| fig-cap: "Mean-standard deviation relationships for the acute and acclimation responses across all habitats. Relationships are depicted for the low temperature treatment of the study (A) and high temperature treatment (B)."
 ...
 p_mv <-  (mv1 / mv2)  + plot_annotation(tag_levels = "A") + theme(plot.tag = element_text(size = 20))
  ggsave(p_mv, file = "./output/figures/figS6.png", height = 8, width = 8)
  
  p_mv <- magick::image_read("./output/figures/figS6.png")
  p_mv
```
...
################## 
  ...
  ggsave(p3b, filename = "./output/figures/figS7.pdf", width = 11.5, height = 8)

  figs1 <- image_read("./output/figures/figS7.pdf")
  figs1
```
...
ggsave(figbtrait_vr, filename = "./output/figures/figS8.png", width = 28, height = 8, device = "png")

figbtrait <- magick::image_read("./output/figures/figS8.png")
figbtrait
```
...
ggsave(figcvr_lh, filename = "./output/figures/figS9.pdf", width = 28, height = 10, device = "pdf")

figcvr_lh <- magick::image_read("./output/figures/figS9.pdf")
figcvr_lh
...
ggsave(figbtrait, filename = "./output/figures/figS10.png", width = 28, height = 14, device = "png")

figbtrait <- magick::image_read("./output/figures/figS10.png")
figbtrait
```
...
ggsave(fig2, filename = "./output/figures/figS11.png", height = 20, width = 15)

img_fig2 <- magick::image_read("./output/figures/figS11.png")
img_fig2
```
...
ggsave(figvrtrait, filename = "./output/figures/figS12.png", height = 20, width = 15)

img_figvrtrait <- magick::image_read("./output/figures/figS12.png")
img_figvrtrait
```
...
ggsave(figcvrtrait, filename = "./output/figures/figS13.png", height = 20, width = 15)

img_figcvrtrait <- magick::image_read("./output/figures/figS13.png")
img_figcvrtrait
```
...
ggsave(figS12, width = 16, height = 5.7, filename = "./output/figures/figS14.png")

figS12 <- image_read("./output/figures/figS14.png")
figS12
```
...
ggsave(p_acf, width = 18, height = 10, filename = "./output/figures/figS15.pdf")

  p_acf <- image_read("./output/figures/figS15.pdf")
  p_acf 
```
...
ggsave(figs2, width = 11.5, height = 4.8, filename = "./output/figures/figS16.png")

figs2 <- image_read("./output/figures/figS16.png")
figs2
```
...
ggsave(p_sim, width = 22.5, height = 18, filename = "./output/figures/figS17.png")
 
p_sim <- image_read("./output/figures/figS17.png")
p_sim
```
