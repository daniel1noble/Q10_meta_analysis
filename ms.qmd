...
################## 
  ...
  fig3 <- (p3a + p3b) + plot_annotation(tag_levels = "A", tag_suffix = ")")
  fig3
...
fig4 <-(p3 | p1 | p2) / (p3_cvr | p1_cvr | p2_cvr) + plot_annotation(tag_levels = "A", tag_suffix = ")") 
...
if(rerun){
    ...
    acf_all_mod <- bf(acf_all ~ habitat  + (1|record_num) + (1|spp))

  model_envi <- brms::brm(sd_mod + acf_all_mod + set_rescor(TRUE), family = gaussian(),  control = list(adapt_delta = 0.98, max_treedepth = 12), chains = 4, thin = 5, iter = 5000, warmup = 1000, cores = 4, data = lnRRQ10_data_wild)
...
if(rerun){
  # More realistic model with 
  model3.4          <- metafor::rma.mv(effect_size ~ max_temp_c + c_accl_time + acf_all_c + type + type:acf_all_c, V = V,
                                       random = list(~1 | record_num,
                                            ~1 | species_full,
                                            ~1 | trait,
                                            ~1 + max_temp_c| spp,
   ...
   model3.4_bayes <- brms::brm(effect_size | se(sqrt(V), sigma = TRUE) ~  max_temp_c + c_accl_time + acf_all_c + type + type:acf_all_c + (~1 | record_num) + (1 | gr(species_full, cov = A_wild)) + (1 + max_temp_c| spp) + (1|trait), data2 = list(A_wild=A_wild), family = gaussian(), prior = c(prior(normal(0, 10), "Intercept"), prior(student_t(3, 0, 10), "sd")), control = list(adapt_delta = 0.98, max_treedepth = 12), chains = 4, thin = 5, iter = 5000, warmup = 1000, cores = 8, data = lnRRQ10_data_wild)
...
if(rerun){
  # More realistic model with 
  model3.5          <- metafor::rma.mv(effect_size ~ max_temp_c + c_accl_time + cv_c + type, V = V,
                                       random = list(~1 | record_num,
                                            ~1 | species_full,
                                            ~1 | trait,
                                            ~1 + max_temp_c| spp,
   ...
   model3.5_bayes <- brms::brm(effect_size | se(sqrt(V), sigma = TRUE) ~  max_temp_c + c_accl_time + cv_c + type + (~1 | record_num) + (1 | gr(species_full, cov = A_wild)) + (1 + max_temp_c| spp) + (1|trait) + (1|obs), data2 = list(A_wild=A_wild), family = gaussian(), prior = c(prior(normal(0, 10), "Intercept"), prior(student_t(3, 0, 10), "sd")), control = list(adapt_delta = 0.98, max_treedepth = 12), chains = 4, thin = 5, iter = 5000, warmup = 1000, cores = 8, data = lnRRQ10_data_wild)
...
if(rerun){
  # More realistic model with 
  model3.6          <- metafor::rma.mv(effect_size ~ max_temp_c + c_accl_time + acf_all_c + type, V = V,
                                       random = list(~1 | record_num,
                                            ~1 | species_full,
                                            ~1 | trait,
                                            ~1 + max_temp_c| spp,
...
if(rerun){
  # More realistic model with 
  model3.7          <- metafor::rma.mv(effect_size ~ max_temp_c + c_accl_time + acf_all_c + cv_c + type, V = V,
                                       random = list(~1 | record_num,
                                            ~1 | species_full,
                                            ~1 | trait,
                                            ~1 + max_temp_c| spp,
   ...
   model3.7_bayes <- brms::brm(effect_size | se(sqrt(V), sigma = TRUE) ~  max_temp_c + c_accl_time + acf_all_c + cv_c + type + (~1 | record_num) + (1 | gr(species_full, cov = A_wild)) + (1 + max_temp_c| spp) + (1|trait), data2 = list(A_wild=A_wild), family = gaussian(), prior = c(prior(normal(0, 10), "Intercept"), prior(student_t(3, 0, 10), "sd")), control = list(adapt_delta = 0.98, max_treedepth = 12), chains = 4, thin = 5, iter = 5000, warmup = 1000, cores = 8, data = lnRRQ10_data_wild)
...
if(rerun){
    ...
    model3.10_t  <- metafor::rma.mv(effect_size ~ max_temp_c + c_accl_time + cv_c + acf_all_c + acf_all_c:cv_c, V = V,
                                       random = list(~1 | record_num,
                                            ~1 | species_full,
                                            ~1 | trait,
                                            ~1 + max_temp_c| spp,
    ...
    saveRDS(model3.9_f, "./output/models/model3.9_f")
     ...
     model3.10_f  <- metafor::rma.mv(effect_size ~ max_temp_c + c_accl_time + cv_c + acf_all_c + acf_all_c:cv_c, V = V,
                                       random = list(~1 | record_num,
                                            ~1 | species_full,
                                            ~1 | trait,
                                            ~1 + max_temp_c| spp,
    ...
    model3.10_m  <- metafor::rma.mv(effect_size ~ max_temp_c + c_accl_time + cv_c + acf_all_c + acf_all_c:cv_c, V = V,
                                       random = list(~1 | record_num,
                                            ~1 | species_full,
                                            ~1 | trait,
                                            ~1 + max_temp_c| spp,
