---
title: "Reduced plasticity and opportunity for selection in terrestrial ectotherm populations"
...
p <- (zoom_plots[[1]] | plot_spacer() | zoom_plots[[2]]) / map1_current  + plot_layout(heights  = c(1, 2.5)) + plot_annotation(tag_levels = "A", tag_suffix = ")") & theme(plot.tag = element_text(size = 20, face = "bold"))
