...
`r mean(data_wide$acclim_period, na.rm = TRUE)` days) and maximum temperature (i.e., 23°C) across the dataset.
...
CI: `r quantile(phylo_i2, 0.025)[1]` to `r quantile(phylo_i2, 0.975)[1]`%). These patterns were similar for $lnVR_{Q_{10}}$ ( see *Supplementary Materials*, @fig-s3). All results are from Model 1 (see “Meta-Analysis” above).
...
Understanding acclimation capacity and how variation in physiological rates change across populations and species is important for predicting the ecological and evolutionary consequences of climate change [@Chevin2017; @Chevin2010; @Bolnick2011; @bush2016incorporating; @seebacher2023can; @Sanderson2023; @urban2023and]. Here we show that both acclimation responses ($lnRR_{Q_{10}}$) and increases in physiological rate variance ($lnVR_{Q_{10}}$) of ectotherms varied across habitats. Our results uncover an hitherto unrecognised dynamic where the limited benefits of acclimation are potentially compensated for by increases in trait variance that may have impacts on how ectotherm populations across these different habitats will be able to adapt to increased temperatures.

### ***Acclimation capacities vary among habitats but are often still limited***

We show that the capacity for acclimation of physiological rates differs across habitats. Our findings confirm previous results that quantify the different capacity of terrestrial, marine and freshwater ectotherms to acclimate [@Seebacher2015-wi; @Gunderson2015-hz; @morley2019physiological]. Our analysis generally supports that of @Seebacher2015-wi, @Gunderson2015-hz and @morley2019physiological that all show a general inability of terrestrial ectotherms to physiologically acclimate. These consistent results are interesting given the different physiological traits measured in these meta-analyses (i.e., thermal limits versus physiological rates). 

The change in acclimation $Q_{10}$ we found with our expanded dataset (34% increase in effects) was similar to @Seebacher2015-wi for freshwater organisms (~17%), but higher in marine ectotherms [decrease of 16% versus ~10% in @Seebacher2015-wi], and opposite in terrestrial ectotherms [increase of ~6% compared to an ~8% decrease in @Seebacher2015-wi], possibly due to the use of newly derived $Q_{10}$ effect sizes that allow us to control for sampling variance. Greater capacity for acclimation in aquatic organisms may be the result of fewer opportunities for behavioural thermoregulation in aquatic environments making physiological remodeling important for maintaining homeostasis [@Gunderson2015-hz; @morley2019physiological]. Importantly, even though marine and freshwater ectotherms were capable of partial acclimation, on average, the effect size was small (amounting to $Q_{10}$ dropping from ~1.8 to 1.6), suggesting acclimation will provide limited scope for aquatic ectotherms to adjust their physiology to higher temperatures.

Biochemical traits (e.g., enzyme activities) were more likely to acclimate compared to whole-organisms traits as predicted, but only for marine ectotherms, presumably because of the less complicated physiological networks that underlie specific biochemical processes [@schulte2011thermal]. However, this prediction did not hold up generally with both whole-organism and biochemical traits being equally likely to acclimate in freshwater ectotherms, which may be due to the different types of biochemical processes measured in the two habitats. 
...
ggsave(figS12, width = 16, height = 5.7, filename = "./output/figures/figS12.png")

figS12 <- image_read("./output/figures/figS12.png")
figS12
```
