...
In contrast, the opportunity for selection (i.e., the change in physiological variability) did not depend on a populations thermal variability or predictability (@fig-5). 
