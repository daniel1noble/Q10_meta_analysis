...
geom_text(data = dat_text, aes(x = x, y = y, label = TeX(label)), size = 5) + 
geom_text(data = dat_text, aes(x = x, y = y-0.3, label = label2), size = 5) +
geom_text(data = dat_text, aes(x = x, y = y-0.6, label = TeX(p)), size = 5) +
...
p9.1.2 <- (p9.1 / p9.2) + plot_annotation(tag_levels = "A") & theme(plot.tag = element_text(size = 20))
