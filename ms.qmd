...
p <- (zoom_plots[[1]] | plot_spacer() | zoom_plots[[2]]) / map1_current  / (plot_spacer() | plot_spacer() |zoom_plots[[3]]) + plot_layout(heights  = c(1, 2.5, 1)) + plot_annotation(tag_levels = "A", tag_suffix = ")")
