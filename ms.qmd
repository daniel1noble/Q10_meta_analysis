...
Changes in relative variance in physiological rates across habitats was nearly equivalent (marine) or larger (terrestrial) compared to their capacity to acclimate. Only in freshwater ectotherms did acclimation in physiological rates coincide with no change in relative variation. Mechanistically, it is unclear what is contributing to the reduction in relative variation in physiological rates at higher temperatures. One possible explanation may be that biochemical reactions are operating more efficiently or are relying on more conformationally stable enzymes at higher temperatures impacting between individual variation [@tattersall2012coping; @angilletta2009thermal; @somero1995proteins]. Such a mechanism may also help explain the differences in relative variance across habitat types. For example, terrestrial ectotherms may rely on more specialised enzymatic variants that operate over a more limited temperature range individually but together allow for organisms to function over a wider thermal range necessary to operate in more variable thermal environments [@angilletta2009thermal]. Acclimation responses in marine and freshwater organisms may also themselves buffer / maintain variance in physiological rates at higher temperatures due to the expression of alternative enzymes that function more effectively at higher temperatures. Given that biochemical traits in marine and freshwater organisms acclimated, and their relative variance increased in freshwater after acclimation, this seems plausible. 
