...
####################################################
  ...
  scale_fill_manual(values = col) + scale_color_manual(values = rep("black",3)) + ylim(-1.2, 1.2)
