...
```{r}
  bubble_plot(model1.2, mod = "c_accl_time", group = "spp", ylab = TeX("$lnRR_{Q_{10}}$"), xlab = "Centered Acclimaton Time (days)") + theme_classic() + theme(axis.title  = element_text(size = 30), 
                        axis.text = element_text(size = 26), 
                        axis.text.y = element_text(size = 26),
                        legend.text = element_text(size = 24), 
                        legend.title = element_text(size = 26))
