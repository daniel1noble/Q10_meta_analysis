...
###---------------------------------------###
  ...
  lnRRQ10_data_acc_minus_aclim <- data_wide %>%        
                  ...
                  dplyr::select(-lnRR_Q10_acclim, -V_lnRR_Q10_acclim, -lnRR_acute_SV, -lnRR_acute, -grep("r", colnames(.)))  %>% 
...
tree_checks(data = lnRRQ10_data_wild_acute_vs_acclim, tree = tree_lnrr, dataCol = "species_full", type = "check") # Good
