...
<p style="text-align: center;">Daniel W.A. Noble^1^ $\dagger$, Fonti Kar^2^,  Alex Bush^4^, Frank Seebacher^3^ $\dagger$, & Shinichi Nakagawa^2^ $\dagger$</p>
...
^$\dagger$^ Shared senior authorship &NewLine;
