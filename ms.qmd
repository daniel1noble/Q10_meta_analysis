...
# lnRR ACF
####################
 dat_textacf <- data.frame(label = c(text(slope_f), text(slope_m), text(slope_t)),
                      label2 = c(text(slope_f, b = FALSE), text(slope_m,b = FALSE), text(slope_t,b = FALSE)),
                      p = c(p_text(slope_f), p_text(slope_m), p_text(slope_t)),
                      title = c("Freshwater", "Marine", "Terrestrial"), 
                      condition = c("f", "m", "t"),
...
y_adj = -3
# Terrestrial
  p_t_rr_acf <-  bubble_plot(model3.9_t, mod = "cv_c", group = "spp", ylab = TeX("$lnRR_{Q_{10_{acclim}}}$"), xlab = "Thermal Predictability", g = TRUE) + 
    geom_point(data = lnRRQ10_data_wild_acclim_t, aes(x = cv_c, y = effect_size, size = 1/sqrt(V)), fill = col[3], colour = "black", stroke = 0.2, shape = 21) + labs(title = dat_text$title[3]) +
  annotate("text", x = dat_text$x[3], y = y_adj, label = TeX(dat_text$p[3]), size = 8) +
  annotate("text", x = dat_text$x[3], y = y_adj + 0.5, label = TeX(dat_text$label2[3]), size = 8) +
  annotate("text", x = dat_text$x[3], y = y_adj + 1, label = TeX(dat_text$label[3]), size = 8) +
...
# Marine
p_m_rr_acf <-  bubble_plot(model3.9_m, mod = "cv_c", group = "spp", ylab = TeX("$lnRR_{Q_{10_{acclim}}}"), xlab = "Thermal Predictability", g = TRUE) + 
    geom_point(data = lnRRQ10_data_wild_acclim_m, aes(x = cv_c, y = effect_size, size = 1/sqrt(V)), fill = col[2], colour = "black", stroke = 0.2, shape = 21) +  labs(title = dat_text$title[2]) +
  annotate("text", x = dat_text$x[2]-0.5, y = y_adj, label = TeX(dat_text$p[2]), size = 8) +
  annotate("text", x = dat_text$x[2]-0.5, y = y_adj+0.5, label = TeX(dat_text$label2[2]), size = 8) +
  annotate("text", x = dat_text$x[2]-0.5, y = y_adj+1, label = TeX(dat_text$label[2]), size = 8) +
...
# Freshwater
p_f_rr_acf <-  bubble_plot(model3.9_f, mod = "cv_c", group = "spp", ylab = TeX("$lnRR_{Q_{10_{acclim}}}"), xlab = "Thermal Predictability", g = TRUE) + 
    geom_point(data = lnRRQ10_data_wild_acclim_f, aes(x = cv_c, y = effect_size, size = 1/sqrt(V)), fill = col[1], colour = "black", stroke = 0.2, shape = 21) +  labs(title = dat_text$title[1]) +
  annotate("text", x = dat_text$x[1]+0.6, y = y_adj, label = TeX(dat_text$p[1]), size = 8) +
  annotate("text", x = dat_text$x[1]+0.6, y = y_adj+0.5, label = TeX(dat_text$label2[1]), size = 8) +
  annotate("text", x = dat_text$x[1]+0.6, y = y_adj+ 1, label = TeX(dat_text$label[1]), size = 8) +
...
# lnCVR CV
####################
dat_textcvr_acf <- data.frame(label = c(text(slope_f_4.9), 
                                 text(slope_m_4.9), 
                                 text(slope_t_4.9)),
                      label2 = c(text(slope_f_4.9, b = FALSE), 
                                 text(slope_m_4.9,b = FALSE), 
...
# Freshwater
  yadj2 = -6
  x_f = 0.6
  p_f_cv_acf <-  bubble_plot(model4.9_f, mod = "cv_c", group = "spp", ylab = TeX("$lnCVR_{Q_{10_{acclim}}}$"), xlab = "Thermal Predictability", g =FALSE, k = FALSE) + 
      geom_point(data = lnCVRQ10_data_wild_acclim_f, aes(x = cv_c, y = effect_size, size = 1/sqrt(V)), fill = col[1], colour = "black", stroke = 0.2, shape = 21) + 
    annotate("text", x = dat_textcvr$x[1]+x_f, y = yadj2, label = TeX(dat_textcvr$p[1]), size = 8) +
    annotate("text", x = dat_textcvr$x[1]+x_f, y = yadj2+0.8, label = TeX(dat_textcvr$label2[1]), size = 8) +
    annotate("text", x = dat_textcvr$x[1]+x_f, y = yadj2+1.6, label = TeX(dat_textcvr$label[1]), size = 8) +
...
# Marine
  x_m = -0.4
  p_m_cv_acf <-  bubble_plot(model4.9_m, mod = "cv_c", group = "spp", ylab = TeX("$lnCVR_{Q_{10_{acclim}}}$"), xlab = "Thermal Predictability", g =FALSE, k = FALSE) + 
    geom_point(data = lnCVRQ10_data_wild_acclim_m, 
                 aes(x = cv_c, y = effect_size, size = 1/sqrt(V)), 
                 fill = col[2], colour = "black", stroke = 0.2, shape = 21) + 
    annotate("text", x = dat_textcvr$x[1]+x_m, y = yadj2, label = TeX(dat_textcvr$p[2]), size = 8) +
...
x_t = 0
p_t_cv_acf <-  bubble_plot(model4.9_t, mod = "cv_c", group = "spp", ylab = TeX("$lnCVR_{Q_{10_{acclim}}}$"), xlab = "Thermal Predictability", g = FALSE, k = FALSE) + 
  geom_point(data = lnCVRQ10_data_wild_acclim_t, 
               aes(x = cv_c, y = effect_size, size = 1/sqrt(V)), 
               fill = col[3], colour = "black", stroke = 0.2, shape = 21) +
  annotate("text", x = dat_textcvr$x[3]+x_t, y = yadj2, label = TeX(dat_textcvr$p[3]), size = 8) +
...
p_cv_acf <- (p_t_rr_acf + p_m_rr_acf + p_f_rr_acf) / (p_t_cv_acf + p_m_cv_acf + p_f_cv_acf) + plot_annotation(tag_levels = "A") & theme(plot.tag = element_text(size = 36))

ggsave(p_cv_acf, width = 18, height = 10, filename = "./output/figures/fig_p_cv_acf_r1.pdf")
