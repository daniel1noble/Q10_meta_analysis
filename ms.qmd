...
# Observed by Lat/long
  ggplot(data = data_w_pred, aes(y = effect_size, x = lat.y)) + geom_point() + geom_smooth(method = "loess") + labs(x = "Latitude", y = "Predicted Effect Size") + theme_classic() 

  ggplot(data = data_w_pred, aes(y = effect_size, x = long.x)) + geom_point() + geom_smooth(method = "loess") + labs(x = "Longitude", y = "Predicted Effect Size") + theme_classic() 
