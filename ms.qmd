...
We show that acclimation of physiological rates and changes in relative variance differ across habitats. Our findings confirm previous results that quantify the different capacity of terrestrial, marine and freshwater ectotherms to acclimate [@Seebacher2015-wi; @Gunderson2015-hz; @morley2019physiological]. Our analysis generally supports that of @Seebacher2015-wi, @Gunderson2015-hz and @morley2019physiological that all show a general inability of terrestrial ectotherms to physiologically acclimate. The change in acclimation $Q_{10}$ we found was similar to @Seebacher2015-wi for freshwater organisms (~17%), but higher in marine ectotherms (decrease of 16% versus ~10% in @Seebacher2015-wi), and opposite in terrestrial ectotherms (increase of ~6% compared to an ~8% decrease in @Seebacher2015-wi), possibly due to our use of new $Q_{10}$ based effect sizes that allow us to control for sampling variance. Importantly, while marine and freshwater ectotherms were capable of partial acclimation, the effect size was small (amounting to $Q_{10}$ dropping from 1.8 to 1.6), suggesting acclimation will, on average, provide limited capacity to maintain physiological rates in the face of climate change. 

Changes in relative variance in physiological rates across habitats was nearly equivalent (marine) or larger (terrestrial) compared to their capacity to acclimate. Only in freshwater ectotherms did acclimation in physiological rates coincide with no change in relative variation. Mechanistically, it is unclear what is contributing to reduction in relative variation in physiological rates at higher temperatures. One possible explanation may be that biochemical reactions are operating more efficiently or are relying on more conformationally stable enzymes at higher temperatures [@tattersall2012coping; @angilletta2009thermal; @somero1995proteins]. Such a mechanism may also help explain the differences in relative variance across habitat types. Terrestrial ectotherms may be relying on more specialised enzymatic variants that operate over a more limited temperature range individually but together allow for organisms to function over a wider thermal range. Needless to say, our results further highlight the potential vulnerability of terrestrial ectotherms to climate change, while calling into question if acclimation in marine systems will be able to counteract the potentially negative effects of reductions in relative variance. Assuming changes in relative variation in physiological rates are underpinned by genetic variation, and that there is a genetic correlation with fitness, such reductions in physiological variance could limit a populations ability to adapt to future climates [@urban2023and]. 

Importantly, while we seen a reduction in relative variation, absolute variation in physiological rates did increase with temperature (@fig-s1) -- albeit to a much lesser extent in terrestrial and marine habitats compared to freshwater -- supporting the general notion that capacity for adaptation may still be limited. As of yet, it is unclear whether a focus on relative or absolute variance should be prioritized or how behavioural strategies of ectotherms might be able to compensate for the general weak acclimation abilities of many ectotherms. For example, terrestrial species have greater opportunity for behavioural microhabitat selection which is expected to decrease the impacts of climate change in thermally heterogeneous environments [@huey2012predicting]. Future theoretical models, that vary both mean and variance, are needed to better understand the broader evolutionary and ecological implications of our findings.

### ***Plasticity and relative variance in physiological rates do not differ between life stages***
Life-history stages often occupy different ecological niches and exhibit different physiological responses, levels of plasticity, and patterns of mortality in response to temperature. As such, it is becoming increasingly important to understand how climate change will impact different life-history stages [@levy2015resolving; @petitgas2013impacts]. Greater plasticity in early life stages of development is expected to be important to increase resilience to the effects of climate change because early life stages are often particularly vulnerable periods in development [@martin2015age; @stearns1976life]. We show that there were generally similar patterns between early and late life stages across a diversity of taxa, both in terms of variance changes and the capacity for plasticity. On average, our results show that early life stages are not more vulnerable to the impacts of climate change. However, our general meta-analytic findings do not imply that early life stages are not always less plastic, but that such responses are likely context or trait dependent [@carter2020life; @moghadam2019heat]. For example, @moghadam2019heat showed that larval *Drosophila* were more plastic in their heat hardening responses compared to adults. In contrast, @carter2020life showed greater thermal plasticity in metabolic rate for adults but little in pupae of *Onthophagus taurus*.  Despite variation in the literature, very few studies measure multiple life-history stages within the same population. In future research, there needs to be more studies that explicitly compare differences in plasticity among life stages across multiple traits within the same population. 
