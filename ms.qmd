...
annotate("text", x = 1.01, y = 4.0, 
  ...
  geom_segment(aes(x = 0.92, y = 3.9, xend = 1.07, yend = 3.9), 
...
annotate("text", x = 2.01, y = 4.0, 
  ...
  geom_segment(aes(x = 1.92, y = 3.9, xend = 2.07, yend = 3.9), 
                            arrow = arrow(angle = 45, ends = "first", length = unit(0.01, "npc"))) +
...
annotate("text", x = 3.01, y = 4.0, 
  ...
  geom_segment(aes(x = 2.92, y = 3.9, xend = 3.07, yend = 3.9), 
...
################## 
  ...
  annotate("text", x = 3.25, y = 1, 
    ...
    annotate("text", x = 3.25, y = -1.5, label = paste0("P = ", round(pmcmc(t_cvr_mean), digit = 3)), hjust = 0, size = 6) + scale_fill_manual(values = c(col)) + ylim(-2, 1.8) + 
    annotate("text", label= paste0("k = ", k_cvr$k, " (", k_cvr$sdy, ")"), x = k_cvr$moderator, y = 2.4)
