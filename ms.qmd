...
Phenotypic plasticity is expected to evolve in populations when environmental variability is high but predictable and the costs of plasticity are low [@Chevin2017; @Scheiner2020; @Nunney2016; @Dewitt1998; @Reed2010]. Thermal variation and predictability are known to differ across habitats (terrestrial, marine and freshwater) [@steele2019comparison], and as such, we expect the extent of plasticity of organisms within these habitats to vary. Species occupying terrestrial habitats often show weak acclimation abilities, and so, are likely to be particularly vulnerable to climate change given their greater probability of experiencing thermal extremes that overwhelm physiological homeostasis [@Seebacher2015-wi; @Gunderson2015-hz; @hoffmann2013upper; @morley2019physiological]. Marine and freshwater habitats appear to have greater physiological acclimation capacity [e.g., @Seebacher2015-wi; @Pottier2022]. 

Physiological acclimation is driven by endocrine and epigenetic processes that change the underlying physiology to allow organisms to maintain physiological performance around a fitness optimum despite changes in the environment [@seebacher2019histone; @little2013thyroid; @taff2016endocrine]. The focus of research up to now has been primarily on mean physiological responses neglecting how variability in physiological rates might also be impacted at higher temperatures. As mean physiological rates increase with temperature there is reason to believe that the intrapopulation variability might also be impacted. NEED MORE ABOUT WHY VARIANCE NOT JUST IMPORTANCE
...
Differences in plasticity is expected between different life-stages because of distinct patterns of mortality, habitat use and behaviour between early and late life history stages [@martin2015age; @stearns1976life]. Age has also been shown to reduce the capacity for acclimation [e.g., see @rossi2019ageing]. For example, @moghadam2019heat showed that larval *Drosophila* were more plastic in their heat hardening responses compared to adults while @rossi2019ageing show that older air-acclimated fish had a diminished scope for gill remodeling relative to younger fish in mangrove rivulus (*Kryptolebias marmoratus*). 

Despite these examples, more broadly, we show little difference between early and late life acclimation capacities and changes in relative variance across habitats in our data indicating that such responses are likely context or trait dependent [@carter2020life; @moghadam2019heat]. The lack of differences we observed may also be due to the fact that both juvenile and adult animals occupy similar ecological niches with similar dispersal and thermoregulatory behaviors making physiological responses to temperature similar. It is possible that temperatures experienced earlier in development, for example egg or larval stages, exhibit greater capacity for acclimation because of limited dispersal capabilities and very different habitats. Early developmental constraints are known to affect how physiological systems respond later in life because of programmatic effects [@angilletta2009thermal; @noble2018developmental; @o2019developmental], and as such, developmental conditions may also cascade to . Such effects would manifest in juveniles life-history stages   

### ***No signature of past climate on capacity for physiological plasticity***
Theoretical models predict that plasticity should evolve in populations experiencing greater environmental variability (spatial or temporal), particularly when oscillations are predictable over time to make environmental cues more reliable [@Chevin2017; @Lande2009; @Chevin2010; @Nunney2016; @Murren2015; @hendry2016key; @Reed2010]. Higher spatial and temporal heterogeneity in terrestrial habitats [@steele2019comparison] might then suggest that plasticity should be more likely to evolve in terrestrial environments. However, if thermal variability is too high and unpredictable, the rates of acclimation slow, and there are costs associated with re-modelling physiological processes [which seem likely, @angilletta2009thermal] then we would instead expect canalised responses [@angilletta2009thermal; @Seebacher2015-wi; @loughland2020differences]. The lack of acclimation in terrestrial ectotherms we observed is consistent with the latter hypothesis, and is supported by other meta-analyses of heat tolerance [@barley2021limited; @Gunderson2015-hz] (which we did not consider here). However, our results do contrast with comparative studies that show partial support for environmental variability being related to acclimation responses in aquatic habitats [@Seebacher2015-wi; ]

Modelling correct microenvironments for over 200 species across such diverse habitats is challenging. The lack of a relationship between physiological plasticity and environmental variability and predictability could be due to the fact that ectotherms simply seek out microhabitats that make their environment quite stable [@huey2012predicting].  Therefore, it is possible that more fine-scale resolution of the habitats that organisms occupy will elucidate expected patterns. Randomly fluctuating environments have been suggested to select for reduced plasticity, particularly if plastic responses are costly and this has been demonstrated by a number of empirical studies [@Leung2020; @rescan2022experimental; @leung2023phenotypic]. For example, using seed beetles (*Callosobruchus maculatus*), @hallsson2012selection showed that experimentally evolving populations under randomly fluctuating thermal conditions did not show any increase in plasticity, but had reduced plasticity. @Leung2020 also showed reduced plasticity in morphological traits of experimentally evolving algae populations (*Dunaliella salina*) when environments were less predictable [see also @leung2023phenotypic]. While it is unclear how these findings relate directly to acclimation because they integrate multiple forms of plasticity, they do suggest that there are costs to being plastic or that the environmental signals are insufficient to trigger endocrine and epigenetic mechanisms that lead to plasticity when environments are not predictable [@Leung2020; @hendry2016key]. The fact that aquatic ectotherms did show a capacity to acclimate suggests that environmental predictability, which is expected to be higher in aquatic environments, may be more important than environmental variability in driving the evolution of plasticity, but it is unclear how this can be measured across diverse taxa at a biologically relevant spatial and temporal scale. 
