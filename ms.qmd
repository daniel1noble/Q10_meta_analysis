...
^3^ School of Life and Environmental Sciences, University of Sydney, Sydney, NSW 2006, Australia  &NewLine;  
...
Climate change is expected to result in warmer and more variable thermal environments globally. Maintaining variability in physiological rates and adjusting them in response to extreme temperatures (plasticity) is essential for allowing populations to adapt to climate change. Yet, incorporating both plasticity and changes in phenotypic variation when predicting the impacts of climate change on populations is often ignored. We developed effect size estimates that quantify how physiological rate variance changes relative to the mean as temperature increases, which we refer to as 'relative variance'. We show by meta-analysing >1900 effects from 226 species that relative variance in physiological rates decreases at higher temperatures driven by the lower proportional increase in physiological rate variance relative to the mean. Freshwater ectotherms are capable of acclimating and have the smallest reductions in relative variance. Marine organisms also acclimated, but plasticity traded-off with a reduction in relative variance in physiological rates at higher temperatures. Relative variance reductions were particularly pronounced for terrestrial ectotherms, and this coincided with a lack of capacity for acclimation, highlighting the vulnerability of terrestrial ectotherms to climate change. Our results show that, while there are weak acclimation responses in some habitats (marine and freshwater), such responses may trade-off with reductions in relative physiological rate variance that may have important evolutionary and ecological ramifications that affect our understanding of how climate change will impact populations now and in the future.


## **Introduction**

Climate change is expected to result in warmer but also more variable thermal environments globally [@Suarez2023; @Easterling2000; @Ummenhofer2017]. Greater thermal variability is predicted to result in strong selection pressures that lead to genetic adaptation and/or the evolution of adaptive phenotypic plasticity -- both of which are considered important for population resilience to contemporary human-induced climate change [@Seebacher2015-wi; @Merila2014; @Chevin2015; @Chevin2017; @Chevin2010; @Nunney2016; @seebacher2023can; @cooke2021one]. Without plasticity or adaptation, high extinction rates are expected unless organisms can migrate to track suitable habitats [@Cahill2012; @Nunney2016].

Reversible phenotypic plasticity, such as physiological acclimation, is relatively rapid and can be fine-tuned to proximate environmental conditions making it the first ‘line-of-defense’ against rapid environmental change [@Dewitt1998; @Scheiner2020]. For example, physiological rates are known to speed up as temperature increases because of the thermodynamic effects on chemical reaction rates -- so called 'acute' temperature responses (@fig-concept). Acute temperature increases that push organisms from their thermal optimum can be mitigated by plastically adjusting reaction rates in response to chronic temperatures through acclimation [@Seebacher2015-wi; @Havird2020-mj]. Acclimation alters acute thermal sensitivity to offset the potentially negative effects of acute temperature changes (e.g., higher energetic demands). Acclimation, however, does not normally result in physiological rates returning to their original state (‘complete’ compensation - *sensu* @huey1999testing), but rather are only partially compensated [@huey1999testing; @Havird2020-mj]. 

Physiological acclimation is driven by endocrine and epigenetic processes that change the underlying physiology to allow organisms to maintain physiological performance around a fitness optimum despite changes in the environment [@seebacher2019histone; @little2013thyroid; @taff2016endocrine]. However, the focus up to now has been primarily on mean physiological responses neglecting how variability in physiological rates might also be impacted at higher temperatures.

As mean physiological rates increase with temperature there is reason to believe that the intrapopulation variability might also be impacted. NEED MORE ABOUT WHY VARIANCE NOT JUST IMPORTANCE

Changes in variability of traits governing energy demand could have important consequences on the flow of energy within and between populations, communities, and ecosystems [@hendry2016key; @seebacher2023can; @barneche2021warming; @Sanderson2023]. More variable populations, genetically and/or phenotypically, are predicted to be associated with broader niches, reduced intraspecific competition, increased growth rate, decreased vulnerability to environmental change and lower extinction risk [@forsman2015rethinking; @forsman2014effects; @Bolnick2011; @hendry2016key; @hart2016variation]. Maintaining intrapopulation variability in physiological rates in a warmer world may therefore be important for population resilience to climate change. 

Phenotypic plasticity is expected to evolve in populations when environmental variability is high but predictable and the costs of plasticity are low [@Chevin2017; @Scheiner2020; @Nunney2016; @Dewitt1998; @Reed2010]. Thermal variation and predictability are known to differ across major habitats (terrestrial, marine and freshwater), and as such, we expect the extent of plasticity to vary. Species occupying terrestrial habitats often show weak acclimation abilities, and so, are likely to be particularly vulnerable to climate change given their greater probability of experiencing thermal extremes that overwhelm physiological homeostasis [@Seebacher2015-wi; @Gunderson2015-hz; @hoffmann2013upper; @morley2019physiological]. Marine and freshwater habitats appear to have greater physiological acclimation capacity [e.g., @Seebacher2015-wi; @Pottier2022]. However, it is unclear if the magnitude of physiological adjustment is sufficient to compensate for potentially negative environmental effects, particularly when temperature interacts with other abiotic changes. Low oxygen availability may be a major factor influencing the vulnerability of aquatic habitats, whereas remaining close to thermal limits and greater water loss is expected to be a stronger constraint on physiological processes in terrestrial ectotherms [@Verberk2016]. Given the observed variation among terrestrial and aquatic ectotherms in their acclimation capacity and the different challenges associated with living in air versus water, the effect of climate warming on variation in physiological traits may differ among terrestrial and aquatic habitats, which may have important cascading effects on energy transfer and productivity between these habitats [@seebacher2023can; @barneche2021warming]. 

Understanding how variability in physiological rates are affected by climate change is important because lack of physiological variation can limit responses to selection (i.e., the 'opportunity for selection on a trait') [@Pelletier2012].  Decreases in phenotypic variance also suggests strong stabilising selection or reflects constraints on performance [@Scheiner2020; @Dewitt1998]. Changes in physiological trait variation may also have important ecological consequences by promoting population productivity and stability [@Agashe2009; @kooijman1989population], species coexistence and ecosystem processes [@imura2003genetic; @Bolnick2011; @hart2016variation; @Sanderson2023]. Higher physiological variance in a population may also indicate greater niche breadth which can buffer populations against environmental change (i.e., the portfolio effect) [@Bolnick2011; @Schindler2010; @Zheng2023; @Slatyer2013; @Sanderson2023]. Changes in variance could, therefore, have wide-reaching consequences for understanding the capacity of populations to persist in and adapt to novel environments but to date there are few data testing the importance of variances in this context [@Scheiner2020].

Here, we use meta-analysis to re-evaluate the degree to which aquatic and terrestrial ectotherms are capable of physiological plasticity. We then developed new effect sizes to quantify how variance in physiological rates change with temperature to ask the following questions: 1) How much is variance in physiological rates expected to change, if at all, as temperatures rise? 2) Are temperature effects on plastic adjustments in physiological rates larger than changes in variance across aquatic and terrestrial ectotherms? 3) Are changes in plasticity or variance in physiological rates impacted by past climate history? 4) How are means and variances in physiological rates expected to change under climate change?  


## **Materials and Methods**
### *Literature collection*
We compiled literature on ectothermic animals that measured physiological rates (e.g., metabolic rate) at two or more temperatures after having been acclimated (or acclimatized) at these temperatures. We used data from a previous meta-analysis [@Seebacher2015-wi] and updated @Seebacher2015-wi's data by extracting data from suitable studies from our own searches that followed the same search protocol. For full details on the search protocol see the *Supplementary Materials*, where we also provide a PRISMA flow diagram of our extraction process (@fig-prisma).
...
Monthly average temperature data were extracted from the ERA5 climate model, available from the Copernicus climate data store [@Hersbach2020-hx]. For each population and species in the dataset we extracted a 72-year period (1950-2022) of either surface air temperature (0.01&deg; resolution) for both terrestrial and freshwater taxa, or sea surface temperature for the marine taxa (at 0.25&deg; resolution) using the *ncdf4* R package [vers. `r utils::packageVersion("ncdf4")`, @Pierce2021-lc]. We chose surface temperature because we believed that it was more likely to reflect the micro-thermal environment experienced by terrestrial and freshwater ectotherms at those locations. For terrestrial species we estimated soil temperatures as this maybe more representative of microhabitat choice compared to air temperature. We fit models using both air and soil temperature and found that the results were qualitatively similar. We therefore only present results for air temperature.
...
Lastly, to illustrate the effects that climate warming could have on physiological rate variance we also extracted climate projections and calculated thermal variability and predictability for the future. We used the CanESM2 climate model (2005-2100) [vers. 1.2.0; @koen_hufkens_2019_2647541] under a high emissions scenario (RCP8.5). 

### *Meta-Analysis*
We analysed our data using multilevel meta-analytic (MLMA) and meta-regression (MLMR) models in R (vers. `r paste0(R.Version()$major, ".", R.Version()$minor)`) using *brms* [vers. `r utils::packageVersion("brms")` @Burkner2017-wg; @Burkner2018-ur; @noauthor_2021-az] and *metafor* [vers. `r utils::packageVersion("metafor")` @Viechtbauer2010-fn].  We fit both Bayesian and frequentist approaches to ensure that our results were consistent, and to create orchard plots more easily [vers. 2.0, @Nakagawa2021-ls; @nakagawaorchard]. In addition, Bayesian methods better protect against type I errors in the presence of complex sources of non-independence [@Nakagawa2021-uf; @Song2021-ba; @Noble2017-mz]. In all cases, frequentist and Bayesian models resulted in the same conclusions. For our Bayesian models, we ran 4 MCMC chains, each with a warm-up of 1000 followed by 4000 sampling iterations keeping every 5 iterations for a total of 3200 samples from the posterior distribution. We used flat Gaussian priors for 'fixed' effects (i.e., $N(0, 10)$) and a student t-distribution for 'random' effects (i.e., $student_{t}(3, 0, 10)$). We checked that all MCMC chains were mixing and had converged (i.e., $R_{hat} = 1$). We compared any competing models using Akaike's Information Criteria (AIC) (if frequentist) or Wantabe Information Criteria (WAIC) (if Bayesian). We deemed models with the lowest IC value to be best supported if there was a $\Delta IC$ between the competing models of 2 or more. If two models were within 2 $\Delta IC$ units we went with the most parsimonious model. 

#### *Multi-level Meta-analysis (MLMA) Models*
We first fit multi-level meta-analysis (MLMA) models (i.e., intercept-only models) for both $lnRR_{Q_{10}}$ and $lnCVR_{Q_{10}}$, that included study, species, trait type, and phylogeny as random effects to account for non-independence and identify sources of variability. We refer to this model structure as “Model 1” in the results. Our MLMA models allowed us to partition the variation in $lnRR_{Q_{10}}$ and $lnCVR_{Q_{10}}$ among these key sources while accounting for total sampling variance in each. This allowed us to calculate the proportion of total heterogeneity [i.e., $I_{total}^2$; *sensu* @Nakagawa2012-oc; @Noble2022-ty] along with various $I^2$ metrics describing the proportion of variance explained by each random effect level [@Nakagawa2012-oc]. We also present 95% prediction intervals which describe the expected distribution of effects from future studies [@Nakagawa2021-ls; @Noble2022-ty]. 

A phylogeny was derived using the Open Tree of Life (OTL) with the *rotl* package in R (vers. `r utils::packageVersion("rotl")`) [@Michonneau2016-if], and plotted using *ggtree* (vers. `r utils::packageVersion("ggtree")`) [@Yu2017-wj]. We resolved all polytomies in the tree. Any missing taxa were replaced with closely related species and branch lengths were computed using Grafen's method [using power = 0.7, @Grafen1989-pr]. Models fit using correlation matrices computed with different power (p) parameters (from 0.5 – 1.0) has nearly identical $AIC_{c}$. As such, we used an intermediate value of p = 0.7. We used the R packages *ape* (vers. `r utils::packageVersion("ape")`) [@Paradis2019-gx] and *phytools* (vers. `r utils::packageVersion("phytools")`) [@Revell2012-vq] to prune the tree for individual analyses and calculate phylogenetic covariance (or correlation) matrices used in meta-analytic models.  

#### *Multi-level Meta-regression (MLMR) Models*

After quantifying levels of heterogeneity, we fit a series of multi-level meta-regression (MLMR) models to test our key questions. In all models, we included the same random effects as we used in our MLMA models. Acclimation time varied from `r range(data_wide$acclim_period, na.rm = TRUE)[1]` to `r range(data_wide$acclim_period, na.rm = TRUE)[2]` days (mean $\pm$ SD = `r mean(data_wide$acclim_period, na.rm = TRUE)` $\pm$ `r sd(data_wide$acclim_period, na.rm = TRUE)` days), and terrestrial ectotherms were acclimated for a much shorter duration (mean $\pm$ SD = `r acclim_time[3,2]` $\pm$ `r acclim_time[3,3]` days, n = `r acclim_time[3,4]`) than both freshwater (mean $\pm$ SD = `r acclim_time[1,2]` $\pm$ `r acclim_time[1,3]` days, n = `r acclim_time[1,4]`) and marine species (mean $\pm$ SD = `r acclim_time[2,2]` $\pm$ `r acclim_time[2,3]` days, n = `r acclim_time[2,4]`). Rates of acclimation have been shown to be faster for many terrestrial groups compared to aquatic organisms [e.g., amphibians and reptiles have faster rates of acclimation than fishes; See @Einum2023-lz], which would make it more likely that terrestrial ectotherms would show a smaller acclimation $lnRR_{Q_{10}}$. To control for these possible differences, acclimation time was mean-centered (mean = 0) and included in all our models. 

In addition to acclimation, all our models corrected for the possibility of the log-linearity assumption of our effect sizes being violated. We predicted that, if $lnRR_{Q_{10}}$, $lnCVR_{Q_{10}}$ and $lnVR_{Q_{10}}$ were not strictly log-linear than we would see a decrease in average effect size for studies applying higher temperature treatments because these temperatures are expected to either converge on or cross the thermal optima of the performance curve causing reaction rates to decelerate or decrease beyond $T_{op}$ [@michaletz2024hotter]. The benefit of such an approach means that we could still take advantage of the excellent properties of $Q_{10}$ as an effect size while statistically correcting for the potential non-linearity that would be expected in the data at high treatment temperatures. Given that our data included a wide range of species and habitats, we also included a random slope of maximum temperature that varied across species because we, *a priori*, expected that each species will vary in their thermal performance curve and the chosen temperatures experimentally manipulated along the performance curve. To improve model interpretation, we also mean-centered the maximum temperature and included it in our models. 

With acclimation time and maximum temperature as moderators in all our models we proceeded to build separate models that tested our core questions. All estimates from our models are therefore conditioned on an average level of acclimation time (i.e., `r mean(data_wide$acclim_period, na.rm = TRUE)` days) and maximum temperature (i.e., 23$^\circ C$) across the dataset. 

We first tested the degree to which the difference in acute and acclimation $lnRR_{Q_{10}}$ and $lnCVR_{Q_{10}}$ effects varied by habitat type (i.e., terrestrial, freshwater, and marine). Models included an interaction between effect type (i.e., acute or acclimation) and habitat (referred to as “Model 2”). Reduced mean $lnRR_{Q_{10_{acclimation}}}$ relative to $lnRR_{Q_{10_{acute}}}$ indicates that acclimation to thermal environments results in partial compensation of physiological rates (i.e., phenotypic plasticity), whereas no differences between $lnRR_{Q_{10_{acute}}}$ and $lnRR_{Q_{10_{acclimation}}}$ suggests organisms are not capable of physiological plasticity [@Havird2020-mj; @Seebacher2015-wi]. In contrast, a difference in $lnCVR_{Q_{10_{acclimation}}}$ relative to $lnCVR_{Q_{10_{acute}}}$ would imply that changes in between individual variation in physiological rates across 10&deg;C differ depending on whether acute or acclimation responses are measured. 

Second, we tested whether acute and acclimation $lnRR_{Q_{10}}$ and $lnCVR_{Q_{10}}$ differed between whole-organism versus biochemical traits across habitats by fitting an model with an interaction between type, habitat and trait category (referred to as "Model 3"). We also explored how acute and acclimation effects varied across more detailed trait categories, and these results can be found in the *Supplementary Materials*. Given that residual variance appeared to differ across trait categories we fit heteroscedastic residual variance models which were better supported in all cases ($\Delta AIC_{c}$; marine = 58, freshwater = 120, and terrestrial = 12). 
...
Finally, we tested whether the change in $lnRR_{Q_{10_{acclimation}}}$ and $lnCVR_{Q_{10}}$ were predicted by a populations climate variability (CV). We only used $lnRR_{Q_{10_{acclimation}}}$ for these models because our predictions were specifically focused on the plastic adjustments to physiological rates. We used all $lnCVR_{Q_{10}}$ data because there were no differences between $lnCVR_{Q_{10_{acclimation}}}$ and $lnCVR_{Q_{10_{acute}}}$ and we had no *a priori* reason to believe climate would impact acclimation and acute $lnCVR_{Q_{10}}$ differently. To test how climate variability impacted mean effect size in wild populations we fit models that included an interaction between habitat type and thermal coefficient of variability (CV) as moderators while controlling for acclimation time and maximum temperature used in the experiments (referred to as "Model 5"). We also explored how environmental predictability, as measured by how correlated successive temperatures at a given location were across months, might also explain capacity for acclimation. However, such analyses are challenging to interpret because the temporal scale that is biologically relevant to different organisms will be different making the choice of lag to estimate the correlation difficult to apply across taxa. As such, we report on these results for a single lag (1 month) in the *Supplementary Materials* but note they do not differ from CV analyses.

#### *Modelling how climate change will impact on opportunity for selection*

To understand the consequences of human-induced climate change on the potential to impact the opportunity for selection on physiological traits we fit a model that included an interaction between acclimation type, habitat type, latitude and longitude (referred to as "Model 6"). We assumed that any change in $lnCVR_{Q_{10}}$ across latitude and longitude could vary by habitat type (i.e., an interaction between habitat). We used non-linear tensors for latitude and longitude as any response could be complicated by local factors (e.g., altitude). Our model included random effects of species, trait, phylogeny and study. We predicted the expected change in $lnCVR_{Q_{10}}$ for each wild population in our dataset at the specific populations latitude and longitude. To do this, we first converted the predicted $lnCVR_{Q_{10}}$ to a 1&deg;C change as opposed to 10&deg;C as follows:

$$
lnCVR_{Q_{1}} = \frac{lnCVR_{Q_{10}}}{10}
$$ {#eq-lCVRpred}

@eq-lCVRpred turned the expected change across 10&deg;C to 1&deg;C. We then multiplied this predicted change by the change in air and sea surface temperatures at the locations of each population (and species) that is expected under high emissions scenarios in 2080. 

### *Publication Bias*

We explored the possibility for publication bias graphically using funnel plots, and more formally by including the square root of the inverse effective sample size ($\sqrt{1/ne}$) in our meta-regression models  [@Nakagawa2022-gy]. Funnel plot asymmetry may suggest a form of publication bias called the 'file-drawer' effect whereby low-powered studies are less likely to be published, however, graphical approaches do not account for sources of non-independence and high heterogeneity which can drive apparent funnel asymmetry [@Nakagawa2022-gy]. As such, we included $\sqrt{1/ne}$ as a moderator in a multi-level meta-regression model that accounted for all the random effects (i.e, study, species, trait) and fixed effects (acclimation time, type of effect, habitat, trait category and the interaction between habitat type and trait category) (referred to as "Model 7"). While sampling standard error (or variance) could have been included in our model, @Nakagawa2022-gy suggested instead to use $\sqrt{1/ne}$ (and its square root) to avoid potential problems with using sampling error itself (see @Nakagawa2022-gy for a discussion). 
...
Effect heterogeneity was high (only `r mean(tot_i2)`% of the variance was the result of sampling variability, 95% CI: `r quantile(tot_i2, 0.025)[1]` to `r quantile(tot_i2, 0.975)[1]`%), and most variance was explained by the specific study and type of trait (Study: `r mean(stdy_i2)`% , 95% CI: `r quantile(stdy_i2, 0.025)[1]` to `r quantile(stdy_i2, 0.975)[1]`%; Trait Type: `r mean(trait_i2)`% , 95% CI: `r quantile(trait_i2, 0.025)[1]` to `r quantile(trait_i2, 0.975)[1]`%). Evolutionary relationships among taxa and species ecology (i.e., species random effect) explained little variation in acute and acclimation responses (Species: `r mean(spp_i2)`% , 95% CI: `r quantile(spp_i2, 0.025)[1]` to `r quantile(spp_i2, 0.975)[1]`%; Phylogeny: `r mean(phylo_i2)`% , 95% CI: `r quantile(phylo_i2, 0.025)[1]` to `r quantile(phylo_i2, 0.975)[1]`%). All results are from Model 1 (see “Meta-Analysis” above).

Overall, $lnRR_{Q_{10_{acclimation}}}$ was `r abs(mean(avg_change))`% lower than  $lnRR_{Q_{10_{acute}}}$ across all habitats (95%CI: `r quantile(avg_change, c(0.025, 0.975))[1]` to `r quantile(avg_change, c(0.025, 0.975))[2]`%). Ectotherms in marine and freshwater environments showed partial compensation of physiological rates ([@fig-2]A) amounting to reduced $lnRR_{Q_{10_{acclimation}}}$ of `r abs(mean(change_f))`% (95% CI: `r quantile(change_f, c(0.025, 0.975))[1]` to `r quantile(change_f, c(0.025, 0.975))[2]`) in freshwater and `r abs(mean(change_m))`% (95% CI: `r quantile(change_m, c(0.025, 0.975))[1]` to `r quantile(change_m, c(0.025, 0.975))[2]`) in marine environments. In contrast, terrestrial ectotherms showed no acclimation (possibly even inverse acclimation) -- showing a `r abs(mean(change_t))`% increase in $lnRR_{Q_{10_{acclimation}}}$ (95% CI: `r quantile(change_t, c(0.025, 0.975))[1]` to `r quantile(change_t, c(0.025, 0.975))[2]`, [@fig-2]B). All results are from Model 2 (see “Meta-Analysis” above).

Across habitats the extent to which whole-organism versus biochemical processes acclimated varied ("Model 3"; @fig-btrait A-C; and see Supplement [@fig-S2] for more detailed trait analysis). Biochemical processes were more effective at acclimating compared to whole-organism traits for ectotherms occupying marine habitats (@fig-btrait B), whereas both whole-organism and biochemical traits acclimated in freshwater ectotherms (@fig-btrait C). Unsurprisingly, neither broad trait category showed evidence of acclimation in terrestrial ectotherms (@fig-btrait A). 

Acclimation capacity did not vary consistently by life-history stage with no differences between $lnRR_{Q_{10_{acclimation}}}$ and $lnRR_{Q_{10_{acute}}}$ between adult and juveniles, except for marine habitats where adults appeared to be able to acclimate to a greater extent, although the effect size was small and in the same direction and magnitude of juveniles ("Model 4"; @fig-cvrlh A-C). When comparing between acute and acclimation responses between adults and juveniles there were also no differences across habitats (Adult-Juvenile (Acute): `r mean(acute_all_lh)`, 95% CI: `r quantile(acute_all_lh, 0.025)[1]` to `r quantile(acute_all_lh, 0.975)[1]`, $p_{MCMC}$ = `r pmcmc(acute_all_lh)`; Adult-Juvenile (Acclimation): `r mean(acclim_all_lh)`, 95% CI: `r quantile(acclim_all_lh, 0.025)[1]` to `r quantile(acclim_all_lh, 0.975)[1]`, $p_{MCMC}$ = `r pmcmc(acclim_all_lh)`).
...
##################
  ...
  p3a <- orchaRd::orchard_plot(model1.2, mod = "habitat", group  = "record_num", at = list(type = c("acute", "acclim")), by = "type", weights = "prop", xlab = TeX("$lnRR_{Q_{10}}$"), angle = 20, legend.pos = "top.left", trunk.size = 1.8, branch.size = 2.8, alpha = 0.4) + scale_x_discrete(labels = c("T" = "Terrestrial","M" = "Marine" ,"F" = "Freshwater")) +
...
################## 
  ...
  p3b <- orchard_plot(model2.2, xlab = TeX("$lnCVR_{Q_{10}}$"), by = "type", at = list(type = c("acute", "acclim")), mod = "habitat", group  = "record_num", weights = "prop", angle = 45, trunk.size = 1.8, branch.size = 2.8, alpha = 0.4, k.pos = "none")  +
  ...
  ggsave(fig3, filename = "./output/figures/fig3_r1.pdf", width = 21.88, height = 9)
  
  fig3 <- magick::image_read("./output/figures/fig3_r1.pdf")
  fig3
```

### *Relative variation in physiological rates is reduced in terrestrial and marine ectotherms*

Relative variance in physiological rates ($lnCVR_{Q_{10}}$) showed a decrease with increasing temperature across all habitat types, which was especially pronounced in terrestrial and marine ectotherms. The total proportion of heterogeneity in $lnCVR_{Q_{10}}$ was lower compared to $lnRR_{Q_{10}}$ ($I^2_{sv}$ = `r mean(tot_i2_cvr)`, 95% CI: `r quantile(tot_i2_cvr, 0.025)` to `r quantile(tot_i2_cvr, 0.975)`), with most variation being driven by between-study and trait differences ("Model 1"; see Supplement  @fig-s3). There were no differences between $lnCVR_{Q_{10_{acute}}}$ and $lnCVR_{Q_{10_{acclimation}}}$. Reductions in variance were driven by slower increases in the variance in physiological rates relative to the mean with scaling relationships between log standard deviation and log mean all being smaller than 1 and varying across habitats (See Supplementary Materials). There was a `r mean(t_cvr_mean_ef)`% (95% CI: `r quantile(t_cvr_mean_ef, 0.025)[1]` to `r quantile(t_cvr_mean_ef, 0.975)[1]`, $p_{MCMC}$ = `r pmcmc(t_cvr_mean)`) reduction in relative physiological rate variance for terrestrial ectotherms and a `r mean(m_cvr_mean_ef)`% (95% CI: `r quantile(m_cvr_mean_ef, 0.025)[1]` to `r quantile(m_cvr_mean_ef, 0.975)[1]`, $p_{MCMC}$ = `r pmcmc(m_cvr_mean)`) reduction in relative variation for marine ectotherms when temperatures increased by 10$^\circ$C. In contrast, freshwater ectotherms exhibited a smaller reduction in relative physiological rate variance at high temperatures (`r mean(f_cvr_mean_ef)`%, 95% CI: `r quantile(f_cvr_mean_ef, 0.025)[1]` to `r quantile(f_cvr_mean_ef, 0.975)[1]`, $p_{MCMC}$ = `r pmcmc(f_cvr_mean)`) (results from "Model 2"). 

Across habitats whole-organism versus biochemical processes showed a similar decrease in relative variance in physiological rates (@fig-btrait D-F; see Supplement [@fig-S2] for more detailed trait analysis), except for biochemical processes in ectotherms occupying freshwater habitats, which showed small, albeit significant increase in relative variance when acclimated (@fig-btrait F). Reduced relative variance was particularly prominent for resting metabolic rates and sprint speed although traits differed in whether they exhibited a reduction in variation in physiological rates at high temperatures (see supplemental @fig-S2) ("Model 3"). Each life-history stage exhibited the same pattern of relative variance change in each of the habitats ("Model 4"; @fig-cvrlh). 
...
Thermal variability (i.e., $CV$) experienced by a population in the past did not explain acclimation capacity (@fig-5 A) or changes in physiological rate variance (@fig-5 B) among terrestrial, marine or freshwater populations ("Model 5"). 
...
Measurements of acute and acclimation responses from wild ectotherms were much less common than from captive populations ($N_{species}$ = `r length(unique(all_pred$spp))`, from `r length(unique(all_pred$uniques))` wild populations). Globally, there was a clear bias towards species in the Northern Hemisphere (@fig-fig6 A-C). Projected changes in physiological rate variance were highly variable across the globe, with some regions showing a decrease in physiological rate variance, while others showing an increase (@fig-fig6 D). However, out of the `r length(unique(all_pred2$match))` populations, relative variance was predicted to decrease in `r (sum(decreases$n, na.rm = TRUE) / length(decreases$n[complete.cases(decreases$n)]))*100`% of the locations. 

Using the ERA5 climate model, predictions of current global changes in physiological rate variance were generally conservative with our model explaining ~ 50% of the variation in the observed data ($R^2$ = `r round(mean(r2_2), 2)`, 95% CI: `r round(quantile(r2_2, 0.025)[1], 2)` to `r round(quantile(r2_2, 0.975)[1], 2)`). Climate change is predicted to result in a `r abs(lapply(mean_perc_habitat, mean)$f)`% reduction in relative variance for freshwater systems (95% CI: `r lapply(mean_perc_habitat, function(x) quantile(x, c(0.025, 0.975)))$f[1]` to `r lapply(mean_perc_habitat, function(x) quantile(x, c(0.025, 0.975)))$f[2]`%, $p_{MCMC}$ = `r pmcmc(mean_perc_habitat$f)`), a `r abs(lapply(mean_perc_habitat, mean)$m)`% reduction in relative variance for marine systems (95% CI: `r lapply(mean_perc_habitat, function(x) quantile(x, c(0.025, 0.975)))$m[1]` to `r lapply(mean_perc_habitat, function(x) quantile(x, c(0.025, 0.975)))$m[2]`%, $p_{MCMC}$ = `r pmcmc(mean_perc_habitat$m)`), and a `r abs(lapply(mean_perc_habitat, mean)$t)`% reduction in relative variance for terrestrial systems (95% CI: `r lapply(mean_perc_habitat, function(x) quantile(x, c(0.025, 0.975)))$t[1]` to `r lapply(mean_perc_habitat, function(x) quantile(x, c(0.025, 0.975)))$t[2]`%, $p_{MCMC}$ = `r p_value(pmcmc(mean_perc_habitat$t))`) under a RCP8.5 climate scenario. All results are taken from "Model 6".
...
Understanding acclimation capacity and how variation in physiological rates changes across populations and species is important for predicting the ecological and evolutionary consequences of climate change [@Chevin2017; @Chevin2010; @Bolnick2011; @bush2016incorporating; @seebacher2023can; @Sanderson2023; @urban2023and]. Here, we show that the relative variance ($lnCVR_{Q_{10}}$) in physiological rates of ectotherms decreased across terrestrial, marine and freshwater habitats as temperatures increase, with the decrease being particularly pronounced in terrestrial ectotherms (~28%). These effects are expected to result in a decrease in the variability in physiological rates for marine and terrestrial ectotherms between ~4-13% under future climate change projections. Our results uncover an hitherto unrecognised dynamic where the benefits of acclimation may be counteracted by a decrease in relative trait variance, which when considered along side acclimation capacity, change our understanding of how ectotherms across different habitats will be able to cope with increased temperatures.

### ***Implications of differing acclimation capacities and decreased relative variability in physiological rates among ectotherms***

We show that acclimation of physiological rates and changes in relative variance differ across habitats. Our findings confirm previous results that quantify the different capacity of terrestrial, marine and freshwater ectotherms to acclimate [@Seebacher2015-wi; @Gunderson2015-hz; @morley2019physiological]. Our analysis generally supports that of @Seebacher2015-wi, @Gunderson2015-hz and @morley2019physiological that all show a general inability of terrestrial ectotherms to physiologically acclimate. The change in acclimation $Q_{10}$ we found was similar to @Seebacher2015-wi for freshwater organisms (~17%), but higher in marine ectotherms (decrease of 16% versus ~10% in @Seebacher2015-wi), and opposite in terrestrial ectotherms (increase of ~6% compared to an ~8% decrease in @Seebacher2015-wi), possibly due to the use of new $Q_{10}$ based effect sizes that allow us to control for sampling variance. Greater capacity for acclimation in aquatic organisms may be the result of fewer opportunities for behaviuoral thermoregulation in aquatic environments making physiological remodeling important for maintaining homeostasis [@Gunderson2015-hz; @morley2019physiological]. While marine and freshwater ectotherms were capable of partial acclimation it is still important to recognise that, on average, the effect size was small (amounting to $Q_{10}$ dropping from ~1.8 to 1.6).

Changes in relative variance in physiological rates across habitats was nearly equivalent (marine) or larger (terrestrial) compared to their capacity to acclimate. Only in freshwater ectotherms did acclimation in physiological rates coincide with no change in relative variation. Mechanistically, it is unclear what is contributing to the reduction in relative variation in physiological rates at higher temperatures. One possible explanation may be that biochemical reactions are operating more efficiently or are relying on more conformationally stable enzymes at higher temperatures impacting between individual variation [@tattersall2012coping; @angilletta2009thermal; @somero1995proteins]. Such a mechanism may also help explain the differences in relative variance across habitat types. For example, terrestrial ectotherms may rely on more specialised enzymatic variants that operate over a more limited temperature range individually but together allow for organisms to function over a wider thermal range necessary to operate in more variable thermal environments [@angilletta2009thermal]. Acclimation responses in marine and freshwater organisms would also result in the maintenance, or even increase, in variance at higher temperatures due to the expression of alternative enzymes that function more effectively at higher temperatures. Given that biochemical traits in marine and freshwater organisms acclimated, and their relative variance increased in freshwater after acclimation, this seems plausible. 

Our results further highlight the potential vulnerability of terrestrial ectotherms to climate change, while calling into question if acclimation in marine systems will be able to counteract the potentially negative effects of reductions in relative variance. Assuming changes in relative variation in physiological rates are underpinned by genetic variation, and there is a genetic correlation with fitness, such reductions in physiological variance could limit a populations ability to adapt to future climates [@urban2023and]. Of course, considering how behavioural modifications buffer organisms from high temperatures is also needed. Terrestrial species likely have greater opportunity for behavioural microhabitat selection in thermally heterogeneous environments which is expected to decrease the impacts of climate change [@huey2012predicting; @sunday2014thermal]. Importantly, while we seen a reduction in relative variation, absolute variation in physiological rates did increase with temperature (@fig-s1) -- albeit to a much lesser extent in terrestrial and marine habitats compared to freshwater -- supporting the general notion that capacity for adaptation may still be limited in terrestrial and marine habitats. As of yet, it is unclear whether a focus on relative or absolute variance should be prioritized. Future theoretical models, that vary both mean and variance, are needed to characterise the interplay between changes in mean and variance. 

### ***Plasticity and relative variance in physiological rates do not differ between life stages***
We show that early (juvenile) and late (adult) life stages exhibited similar acclimation capacities and changes in relative variance across habitats. The lack of differences we observed may be due to the fact that both juvenile and adult animals occupy similar ecological niches and thermoregulate in similar ways making physiological responses to temperature similar. It is possible that temperatures experienced earlier in development, for example egg or early larval stages, would show different patterns because early developmental constraints are known to affect how physiological systems respond later in life because of programmatic effects [@angilletta2009thermal; @noble2018developmental; @o2019developmental]. Such effects would manifest in juveniles life-history stages   

environments are expected Life-history stages often occupy different ecological niches and exhibit different physiological responses, levels of plasticity, and patterns of mortality in response to temperature. As such, it is becoming increasingly important to understand how climate change will impact different life-history stages [@levy2015resolving; @petitgas2013impacts]. Greater plasticity in early life stages of development is expected to be important to increase resilience to the effects of climate change because early life stages are often particularly vulnerable periods in development [@martin2015age; @stearns1976life].  On average, our results show that early life stages are not more vulnerable to the impacts of climate change. However, our general meta-analytic findings do not imply that early life stages are not always less plastic, but that such responses are likely context or trait dependent [@carter2020life; @moghadam2019heat]. For example, @moghadam2019heat showed that larval *Drosophila* were more plastic in their heat hardening responses compared to adults. In contrast, @carter2020life showed greater thermal plasticity in metabolic rate for adults but little in pupae of *Onthophagus taurus*.  Despite variation in the literature, very few studies measure multiple life-history stages within the same population. In future research, there needs to be more studies that explicitly compare differences in plasticity among life stages across multiple traits within the same population. 

### ***No signature of past climate on capacity for physiological plasticity***
Theoretical evolutionary models predict that plasticity should evolve in populations experiencing greater environmental variability (spatial or temporal), particularly when oscillations are predictable over time to make environmental cues more reliable [@Chevin2017; @Lande2009; @Chevin2010; @Nunney2016; @Murren2015; @hendry2016key; @Reed2010]. Higher spatial and temporal heterogeneity in terrestrial habitats [@steele2019comparison] suggests that plasticity should be more likely to evolve in terrestrial environments. However, we did not find evidence of this effect, which is consistent with other meta-analyses of heat tolerance [@barley2021limited; @Gunderson2015-hz] (which we did not consider here). Modelling correct microenvironments for over 200 species across such diverse habitats is challenging. The lack of a relationship between physiological plasticity and environmental variability and predictability could be due to the fact that ectotherms simply seek out microhabitats that make their environment quite stable [@huey2012predicting].  Therefore, it is possible that more fine-scale resolution of the habitats that organisms occupy will elucidate expected patterns. Randomly fluctuating environments have been suggested to select for reduced plasticity, particularly if plastic responses are costly and this has been demonstrated by a number of empirical studies [@Leung2020; @rescan2022experimental; @leung2023phenotypic]. For example, using seed beetles (*Callosobruchus maculatus*), @hallsson2012selection showed that experimentally evolving populations under randomly fluctuating thermal conditions did not show any increase in plasticity, but had reduced plasticity. @Leung2020 also showed reduced plasticity in morphological traits of experimentally evolving algae populations (*Dunaliella salina*) when environments were less predictable [see also @leung2023phenotypic]. While it is unclear how these findings relate directly to acclimation because they integrate multiple forms of plasticity, they do suggest that there are costs to being plastic or that the environmental signals are insufficient to trigger endocrine and epigenetic mechanisms that lead to plasticity when environments are not predictable [@Leung2020; @hendry2016key]. The fact that aquatic ectotherms did show a capacity to acclimate suggests that environmental predictability, which is expected to be higher in aquatic environments, may be more important than environmental variability in driving the evolution of plasticity. 


### ***Conclusions and future directions***

Enhanced knowledge of how variation in physiological rates vary across populations and species and the degree to which they can be adjusted in response to the environment may lead to more informed predictions about the ecological and evolutionary dynamics of natural populations [@forsman2015rethinking; @seebacher2023can; @cooke2021one; @Sanderson2023]. While we show general patterns across taxa and habitats it is important to recognise that this does not mean such patterns apply to all populations. Substantial variation in acclimation responses and changes in variance exist among populations, as evidenced by wide prediction intervals. Nonetheless, changes in the relative variance in physiological rates could be better incorporated into physiological and ecological models to provide more nuanced, and possibly more realistic, predictions about the impacts of climate change on natural populations. 

While we do not yet understand the relative contribution of environmental and genetic factors to variance changes, models could better decouple how different levels of heritability and total variance impact evolutionary and ecological predictions. Our meta-analysis now provides the opportunity to parameterise such models, and ensure they are better aligned with empirical findings. Many fascinating questions remain unanswered that will require greater focus on the consequences of changes in variance (rather than just the mean). Particularly interesting questions include: How does a reduction in physiological rate variance change energy flow across trophic levels within communities? What are the biochemical, cellular, and physiological mechanisms that underlie reduced variance in physiological rates? Are reductions in variance in one trait associated with reductions in correlated traits, or do some traits increase while others decrease? How much of the reduction in variance is driven by lower levels of genetic variance? Answers to these questions will require integrative approaches that combine empirical and theoretical work across multiple levels of biological organisation but will likely provide useful advances in understanding the full consequences that climate change will have on ectotherms across all major ecosystems. 

## Funding
DWAN is supported by an Australian Research Council (ARC) Future Fellowship (FT220100276) and ARC Discovery Project (DP210101152). SN is supported by ARC Discovery Project Grants (DP210100812 and DP230101248).
...
#| fig-cap: "Bubble plot of the relationship between $lnRR_{Q_{10}}$ and maximum temperature used in treatments within a study. Temperature is centered around the mean temperature in the data."
...
rerun = FALSE
if(rerun) { 
      model_mv1  <- brm(log(r1.1_sd) ~ log(r1.1)*habitat + (1|record_num) + (1|spp) + (1|trait), chains = 4, cores = 4, iter = 4000, warmup = 1000, thin = 1, control = list(adapt_delta = 0.98), data = lnRRQ10_data)
      saveRDS(model_mv1, file = "./output/models/model_mv1")
      
      model_mv2  <- brm(log(r1.2_sd) ~ log(r1.2)*habitat + (1|record_num) + (1|spp) + (1|trait), chains = 4, cores = 4, iter = 4000, warmup = 1000, thin = 1, control = list(adapt_delta = 0.98), data = lnRRQ10_data)
      saveRDS(model_mv2, file = "./output/models/model_mv2")
} else {
        model_mv1 <- readRDS("./output/models/model_mv1")
        model_mv2 <- readRDS("./output/models/model_mv2")
}
...
Overall, we found that the relationship between log(mean) and log(SD) of the acute and acclimation responses was generally linear, suggesting that the use of $lnCVR_{Q_{10}}$ was justified (@fig-mv). Overall, the scaling relationship between log(SD) and log(mean) was sub-linear across all habitats (Freshwater = $\Beta$ = `r fixef(model_mv1)[2]`, 95% CI: `r fixef(model_mv1)[2,3]` to  `r fixef(model_mv1)[2,4]`; Marine = $\Beta$ = `r fixef(model_mv1)[2] + fixef(model_mv1)[5]`, 95% CI: `r fixef(model_mv1)[2,3] + fixef(model_mv1)[5,3]` to `r fixef(model_mv1)[2,4] + fixef(model_mv1)[5,4]`; Terrestrial: $\Beta$ = `r fixef(model_mv1)[2] + fixef(model_mv1)[6]`, 95% CI: `r fixef(model_mv1)[2,3] + fixef(model_mv1)[6,3]` to `r fixef(model_mv1)[2,4] + fixef(model_mv1)[6,4]`) suggesting that the variance in physiological rates does not increase proportionally as the mean increases. Importantly, the scaling relationship between log(SD) and log(mean) differed significantly between habitats (Freshwater compared to Marine: Contrast = `r fixef(model_mv1)[5]`, 95% CI: `r fixef(model_mv1)[5,3]` to `r fixef(model_mv1)[5,4]` and Terrestrial to Marine: Contrast = `r fixef(model_mv1)[6]`, 95% CI: `r fixef(model_mv1)[6,3]` to `r fixef(model_mv1)[6,4]`), which helps explain the relative .
...
With these limitations in mind, we used our temperature time series to calculate auto regressive correlation in temperature across the entire time series. We then modeled how this measure of thermal predictability was related to plasticity. 
