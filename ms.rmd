...
```{r, fig6, fig.align='center', fig.cap= "I2 estimates lnCVR"}
p6 <- bubble_plot(model3.5, mod = "cv", group  = "record_num", data = lnRRQ10_data_wild, ylab = TeX("$lnRR_{Q_{10}}$"), xlab = "Thermal Coefficient of Variation (CV)")

p7 <- bubble_plot(model3.6, mod = "acf_all", group  = "record_num", data = lnRRQ10_data_wild, ylab = TeX("$lnRR_{Q_{10}}$"), xlab = "Thermal Autocorrelation") + theme(axis.title.y = element_blank())
  
p67 <- (p6 | p7) + plot_annotation(tag_levels = "A")
  
ggsave(p67, filename = "./output/figures/fig6.png")
```
