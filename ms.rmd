...
Variable thermal environments are expected to result in strong selection pressures that result in adaptation or the evolution of phenotypic plasticity. Plasticity and adaptation are considered critical for population resilience to human-induced climate change. 
...
```{r fig1a, fig.wdith = 10, fig.height=9, fig.cap="Phylogenetic tree"}
