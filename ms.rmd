...
if(rerun){
  ...
  # Check whether there is differences in variances for each habitat
  model1.2_het <- metafor::rma.mv(effect_size ~  c_accl_time + type + habitat + type:habitat, V = V, 
                              random = list(~1 | record_num,
                                            ~1 | species_full,
                                            ~1 | trait,
                                            ~1 | spp,
                                            ~1 + habitat | obs),
                              R = list(species_full = phylo_cor), struct = "HCS", rho = 0, dfs = "contain", 
                              test = "t", data = lnRRQ10_data)
