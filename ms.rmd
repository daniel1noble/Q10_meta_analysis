...
#################################################
# Model controlling for acclimation time, 
...
orchard_plot(model1.3, mod = "trait_category", at = list(type = c("acute", "acclim"), habitat = c("m")),  group = "record_num", weights = "prop", data = lnRRQ10_data, xlab = "lnRRQ10") 
