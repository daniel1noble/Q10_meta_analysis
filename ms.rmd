...
if(rerun){
  # More realistic model with 
  model3.3          <- metafor::rma.mv(effect_size ~ c_accl_time + scale(cv) + type + type:scale(cv), V = V,
                                       random = list(~1 | record_num,
                                            ~1 | species_full,
                                            ~1 | trait,
                                            ~1 | spp,
   ...
   model3.3_bayes <- brms::brm(effect_size | se(sqrt(V)) ~  c_accl_time + scale(cv) + type + type:scale(cv) + (~1 | record_num) + (1 | gr(species_full, cov = A_wild)) + (1 | spp) + (1|trait) + (1|obs), data2 = list(A_wild=A_wild), family = gaussian(), prior = c(prior(normal(0, 10), "Intercept"), prior(student_t(3, 0, 10), "sd")), control = list(adapt_delta = 0.98, max_treedepth = 12), chains = 4, thin = 5, iter = 5000, warmup = 1000, cores = 4, data = lnRRQ10_data_wild)
  ...
  if(rerun){
  # More realistic model with 
  model3.4          <- metafor::rma.mv(effect_size ~ c_accl_time + scale(acf_all) + type + type:scale(acf_all), V = V,
                                       random = list(~1 | record_num,
                                            ~1 | species_full,
                                            ~1 | trait,
                                            ~1 | spp,
   ...
   model3.4_bayes <- brms::brm(effect_size | se(sqrt(V)) ~  c_accl_time + scale(acf_all) + type + type:scale(acf_all) + (~1 | record_num) + (1 | gr(species_full, cov = A_wild)) + (1 | spp) + (1|trait) + (1|obs), data2 = list(A_wild=A_wild), family = gaussian(), prior = c(prior(normal(0, 10), "Intercept"), prior(student_t(3, 0, 10), "sd")), control = list(adapt_delta = 0.98, max_treedepth = 12), chains = 4, thin = 5, iter = 5000, warmup = 1000, cores = 4, data = lnRRQ10_data_wild)
...
if(rerun){
  # More realistic model with 
  model3.5          <- metafor::rma.mv(effect_size ~ c_accl_time + scale(cv) + type, V = V,
                                       random = list(~1 | record_num,
                                            ~1 | species_full,
                                            ~1 | trait,
                                            ~1 | spp,
  ...
  if(rerun){
  # More realistic model with 
  model3.6          <- metafor::rma.mv(effect_size ~ c_accl_time + scale(acf_all) + type, V = V,
                                       random = list(~1 | record_num,
                                            ~1 | species_full,
                                            ~1 | trait,
                                            ~1 | spp,
   ...
   model3.6_bayes <- brms::brm(effect_size | se(sqrt(V)) ~  c_accl_time + scale(acf_all) + type + (~1 | record_num) + (1 | gr(species_full, cov = A_wild)) + (1 | spp) + (1|trait) + (1|obs), data2 = list(A_wild=A_wild), family = gaussian(), prior = c(prior(normal(0, 10), "Intercept"), prior(student_t(3, 0, 10), "sd")), control = list(adapt_delta = 0.98, max_treedepth = 12), chains = 4, thin = 5, iter = 5000, warmup = 1000, cores = 4, data = lnRRQ10_data_wild)
  ...
  if(rerun){
  # More realistic model with 
  model3.7          <- metafor::rma.mv(effect_size ~ c_accl_time + scale(acf_all) + scale(cv) + type, V = V,
                                       random = list(~1 | record_num,
                                            ~1 | species_full,
                                            ~1 | trait,
                                            ~1 | spp,
   ...
   model3.7_bayes <- brms::brm(effect_size | se(sqrt(V)) ~  c_accl_time + scale(acf_all) + scale(cv) + type + (~1 | record_num) + (1 | gr(species_full, cov = A_wild)) + (1 | spp) + (1|trait) + (1|obs), data2 = list(A_wild=A_wild), family = gaussian(), prior = c(prior(normal(0, 10), "Intercept"), prior(student_t(3, 0, 10), "sd")), control = list(adapt_delta = 0.98, max_treedepth = 12), chains = 4, thin = 5, iter = 5000, warmup = 1000, cores = 4, data = lnRRQ10_data_wild)
...
###################################################
  ...
  m_acclim_wild_cvr <- posteriors_4.2[,"b_Intercept"] + posteriors_4.2[,"b_habitatm"] + posteriors_4.2[,"b_typeacclim"] + posteriors_3.2[,"b_typeacclim:habitatm"]
...
####################################################
# Model 4.3-4.7: Model environmental variability 
####################################################
  rerun = TRUE
if(rerun){
  # More realistic model with 
  model4.3          <- metafor::rma.mv(effect_size ~ c_accl_time + scale(cv) + type + type:scale(cv), V = V,
                                       random = list(~1 | record_num,
                                            ~1 | species_full,
                                            ~1 | trait,
                                            ~1 | spp,
  ...
  if(rerun){
  # More realistic model with 
  model4.4          <- metafor::rma.mv(effect_size ~ c_accl_time + scale(acf_all) + type + type:scale(acf_all), V = V,
                                       random = list(~1 | record_num,
                                            ~1 | species_full,
                                            ~1 | trait,
                                            ~1 | spp,
...
if(rerun){
  # More realistic model with 
  model4.5          <- metafor::rma.mv(effect_size ~ c_accl_time + scale(cv) + type, V = V,
                                       random = list(~1 | record_num,
                                            ~1 | species_full,
                                            ~1 | trait,
                                            ~1 | spp,
  ...
  if(rerun){
  # More realistic model with 
  model4.6          <- metafor::rma.mv(effect_size ~ c_accl_time + scale(acf_all) + type, V = V,
                                       random = list(~1 | record_num,
                                            ~1 | species_full,
                                            ~1 | trait,
                                            ~1 | spp,
 ...
 if(rerun){
  # More realistic model with 
  model4.7          <- metafor::rma.mv(effect_size ~ c_accl_time + scale(acf_all) + scale(cv) + type, V = V,
                                       random = list(~1 | record_num,
                                            ~1 | species_full,
                                            ~1 | trait,
                                            ~1 | spp,
