...
The magnitude of difference in $lnRR_{Q_{10}}_{acclimation}$ and $lnRR_{Q_{10}}_{acute}$ was very small (). Considering acute responses of acclimated animals at high temperatures are also expected to increase (see above), acclimatization is not likely going to provide adaptive benefits under climate change. 
