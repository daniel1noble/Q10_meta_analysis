...
Applying new effect sizes that allow us to make use of powerful meta-analytic models we: 1) quantify the degree

ectotherms are capable of physiological plasticity in rates: 1) 
...
ggsave(filename = "fig4.pdf", path = "./output/figures/", phylo, device = "pdf", width = 10, height = 9, units = "in") 
``` 
