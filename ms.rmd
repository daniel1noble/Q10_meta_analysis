...
if(rerun){
  # More realistic model with 
  model3.1          <- metafor::rma.mv(effect_size ~ c_accl_time + type + habitat + type:habitat, V = V,
                                       random = list(~1 | record_num,
                                            ~1 | species_full,
                                            ~1 | trait,
                                            ~1 | spp,
...
# % change on Q10 scale
  p_change_f_q10_wild <- exp(f_acclim_wild - f_acute_wild)-1; quantile(p_change_f_q10_wild, c(0.025, 0.975))
  p_change_m_q10_wild <- exp(m_acclim_wild - m_acute_wild)-1; quantile(p_change_m_q10_wild, c(0.025, 0.975))
  p_change_t_q10_wild <- exp(t_acclim_wild - t_acute_wild)-1; quantile(p_change_t_q10_wild, c(0.025, 0.975))
